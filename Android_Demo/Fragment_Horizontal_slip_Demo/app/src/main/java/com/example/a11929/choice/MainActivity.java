package com.example.a11929.choice;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    private TextView title, item_pre, item_point, item_faxian, item_me;
    ...
    String[] titles = new String[]{"推荐", "观点", "发现", "我的"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        item_pre.setTextColor(Color.parseColor("#66CDAA"));
    ...
    private void initViews() {
        ...
        item_point = (TextView) findViewById(R.id.item_point);
        item_faxian = (TextView) findViewById(R.id.item_faxian);
        item_me = (TextView) findViewById(R.id.item_me);

        item_pre.setOnClickListener(this);
        item_point.setOnClickListener(this);
    ...
    private void changeTextColor(int position) {
        if (position == 0) {
            item_pre.setTextColor(Color.parseColor("#66CDAA"));
            item_point.setTextColor(Color.parseColor("#000000"));
            item_faxian.setTextColor(Color.parseColor("#000000"));
            item_me.setTextColor(Color.parseColor("#000000"));
        } else if (position == 1) {
            item_point.setTextColor(Color.parseColor("#66CDAA"));
            item_pre.setTextColor(Color.parseColor("#000000"));
            item_faxian.setTextColor(Color.parseColor("#000000"));
            item_me.setTextColor(Color.parseColor("#000000"));
        } else if (position == 2) {
